...
aio_password = 'aio_iITj85ac3ncJ5ttYPi5bRt0sHS5Y'
adc1 = None
rgb2 = None
...
adc_calibration_val = 3000

def wifi_connect():
    wifi = network.WLAN(network.STA_IF)
    wifi.active(True)
    wifi.connect('ACCD', 'tink1930')
...
def start_servo_and_rgb(duration):
    ...
    servo1.move(175)  # Move servos at the beginning of the color transition
    servo2.move(15)
